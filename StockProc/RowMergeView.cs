...
namespace StockProc
{
    ...
    public partial class RowMergeView : DataGridView
    {
        ...
        private void RowMergeView_CellMouseDown(object sender, DataGridViewCellMouseEventArgs e)
        {
            //base.OnCellMouseDown(e);
            //this.Rows[e.RowIndex].Selected = !this.Rows[e.RowIndex].Selected;
        }

        private void RowMergeView_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
